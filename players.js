...
var app = {
    ...
    board: $("<div class='gameBoard playersBoard'>" +

        "<!--- Scores --->" +
        "<div class='score' id='boardScore'>0</div>" +
        "<div class='score' id='team1'>0</div>" +
        "<div class='score' data-team='1' id='teamLabel1' >" + team1 + "</div>" +
        "<div class='score' id='team2'>0</div>" +
        "<div class='score' data-team='2' id='teamLabel2' >" + team2 + "</div>" +
        ...
        "<!--- Buttons --->" +
        "<div id='showControls' class='button'>Show Controls</div>" +
        "<div class='btnHolder' hidden>" +
...
window.addEventListener('storage', function (event) {
    if (event.key === 'showQuestion') {
        ...
        renameTeam(event.newValue[0], event.newValue[1]);
